                ...
                <div className="w-full container max-w-screen-lg mx-auto p-8 md:p-4 my-12 flex flex-col md:flex-row items-start gap-8">
                    <div className="w-full md:w-1/3 border border-neutral-200 dark:border-neutral-700 rounded-md p-4">
                        <ul className="list-none">
                            ...
                            <li>
                                <a href="#s12" className="hover:underline">
                                    Section 12
                                </a>
                            </li>
                            <li>
                                <a href="#s13" className="hover:underline">
                                    Section 13
                                </a>
                            </li>
                            <li>
                                <a href="#s14" className="hover:underline">
                                    Section 14
                                </a>
                            </li>
                            <li>
                                <a href="#s15" className="hover:underline">
                                    Section 15
                                </a>
                            </li>
                            <li>
                                <a href="#s16" className="hover:underline">
                                    Section 16
                                </a>
                            </li>
                            <li>
                                <a href="#s17" className="hover:underline">
                                    Section 17
                                </a>
                            </li>
                            <li>
                                <a href="#s18" className="hover:underline">
                                    Section 18
                                </a>
                            </li>
                            <li>
                                <a href="#s19" className="hover:underline">
                                    Section 19
                                </a>
                            </li>
                            <li>
                                <a href="#s20" className="hover:underline">
                                    Section 20
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className="w-full flex flex-col justify-center">
                        <h1 className="text-3xl font-bold mb-4">
                            Capitalize Terms of Service
                        </h1>
                        <p className="mb-8">Last updated: March 11, 2022</p>

                        <h2 className="text-2xl font-bold mb-4" id="s1">
                            OVERVIEW
                        </h2>
                        <p className="mb-4">
                            This website is operated by Capitalize. Throughout
                            the site, the terms “we”, “us” and “our” refer to
                            Capitalize. Capitalize offers this website,
                        ...
                        <p className="mb-4">
                            ...
                            content. Please read these Terms of Service
                            carefully before accessing or using our website. By
                            accessing or using any part of the site, you agree
                            to bebound by these Terms of Service. If you do not
                            agree to all the terms and conditions of this
                        ...
                        <p className="mb-8">
                            ...
                            part of these Terms of Serviceby posting updates
                            ...
                            constitutes acceptance of those changes. Our store
                            is hosted on Shopify Inc. They provide us with the
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s2">
                        ...
                        <p className="mb-4">
                            ...
                            networks or devices. Credit card informationis
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s3">
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s4">
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s5">
                        ...
                        <p className="mb-4">
                            ...
                            our Return Policy. To view our Return Policy, please
                            visit [LINK TO RETURN POLICY]
                        </p>
                        <p className="mb-4">
                            ...
                            accurate. We reserve the right, but are not
                            ...
                            case-by-case basis. We reserve the right to limit
                            the quantities of any products or Services that we
                            offer. All descriptions of products or product
                            pricing are subject to change at anytime without
                            notice, at the sole discretion of us. We reserve the
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s6">
                        ...
                        <p className="mb-4">
                            ...
                            cancel quantities purchased per person, perhousehold
                            or per order. These restrictions may include orders
                            placed by or under the same customer account, the
                            same credit card, and/or orders that use the same
                            billing and/or shipping address. In the event that
                            we make a change to or cancel an order, we may
                            attempt to notify you by contacting the e-mail
                            and/or billing address/phone number provided at the
                            time the order was made. We reserve the right to
                            limit or prohibit orders that, in our sole judgment,
                            appear to be placed by dealers, resellers or
                            distributors. You agree to provide current, complete
                            and accurate purchase and account information for
                            all purchases made at our store. You agree to
                            promptly update your account and other information,
                            including your email address and credit card numbers
                            and expiration dates, so that we can complete your
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s7">
                        ...
                        <p className="mb-4">
                            Any use by you of the optional tools offered through
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s8">
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s9">
                        ...
                        <p className="mb-4">
                            ...
                            any comments. We may, but have no obligation to,
                            monitor, edit or remove content that we determine in
                            our sole discretion to be unlawful, offensive,
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s10">
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s11">
                        ...
                        <p className="mb-4">
                            ...
                            the Service or on anyrelated website is inaccurate
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s12">
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s13">
                        ...
                        <p className="mb-4">
                            In no case shall Capitalize, our directors,
                            ...
                            omissions in anycontent, or any loss or damage of
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s16">
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s17">
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s18">
                            SECTION 18 - GOVERNING LAW
                        </h2>
                        <p className="mb-8">
                            These Terms of Service and any separate agreements
                            whereby we provide you Services shall be governed by
                            and construed in accordance with the laws of United
                            States.
                        </p>

                        <h2 className="text-2xl font-bold mb-4" id="s19">
                        ...
                        <h2 className="text-2xl font-bold mb-4" id="s20">
                            SECTION 20 - CONTACT INFORMATION
                        </h2>
                        <p className="mb-8">
                            Questions about the Terms of Service should be sent
                            to us at capitalize.learning@gmail.com. Our contact
                            information is posted below: [INSERT TRADING NAME]{" "}
                            <br />
